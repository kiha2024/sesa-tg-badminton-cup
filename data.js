/* =====================================================================
   ...
   =====================================================================
   Format: GROUP STAGE (2 grup x 3 tim, round-robin) -> KNOCKOUT
     - Setiap grup main round-robin (semua lawan semua) = 3 laga/grup.
...
window.TOURNAMENT_DATA = {
  ...
  meta: {
    ...
    year: 2026,
    venue: "LEO HALL",
    format: "Group Stage · 2 Grup · Best of 3",
    ...
    prizes: {
      first: { amount: 3000000, note: "2 x Air Fryer" },
      second: { amount: 400000, note: "Uang tunai" },
      third: { amount: 200000, note: "Uang tunai" }
    }
  },
  ...
  /* ---- GROUPS (ISI SETELAH UNDIAN) ----
     Masukkan 3 kode tim (T1..T6) per grup. Urutan bebas.
  ...
  /* ---- BATTLES ----
     Ref tim otomatis — kamu HANYA mengisi schedule & matches:
       { g:"A", i:0 }        -> tim urutan ke-1 di Grup A (index 0,1,2)
  ...
  battles: [
    ...
    },
    {
      ...
      a: { g: "A", i: 0 }, b: { g: "A", i: 2 },
      schedule: { date: "2026-08-13", time: "19:40", court: "Court 1" },
      matches: [{ a: null, b: null }, { a: null, b: null }, { a: null, b: null }]
    },
    {
      id: "A3", stage: "group", group: "A", round: "Grup A · Laga 3",
      a: { g: "A", i: 1 }, b: { g: "A", i: 2 },
      schedule: { date: "2026-08-13", time: "20:20", court: "Court 1" },
      matches: [{ a: null, b: null }, { a: null, b: null }, { a: null, b: null }]
    },
    ...
    },
    {
      ...
      a: { g: "B", i: 0 }, b: { g: "B", i: 2 },
      schedule: { date: "2026-08-20", time: "19:40", court: "Court 1" },
      matches: [{ a: null, b: null }, { a: null, b: null }, { a: null, b: null }]
    },
    {
      id: "B3", stage: "group", group: "B", round: "Grup B · Laga 3",
      a: { g: "B", i: 1 }, b: { g: "B", i: 2 },
      schedule: { date: "2026-08-20", time: "20:20", court: "Court 1" },
      matches: [{ a: null, b: null }, { a: null, b: null }, { a: null, b: null }]
    },
    ...
    },
    {
      ...
      schedule: { date: "2026-08-27", time: "21:00", court: "Court 1" },
      matches: [{ a: null, b: null }, { a: null, b: null }, { a: null, b: null }]
    }
